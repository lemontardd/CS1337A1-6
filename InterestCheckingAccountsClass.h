...
protected:
  ...
  static float minimumBalanceRequired;           // minimum balance required to receive interest
...
public:
  ...
  static void  setMinimmunBlanceRequired(float minimumBalanceRequired)
  { InterestCheckingAccountsClass::minimumBalanceRequired = minimumBalanceRequired; }
  static float getMinimmunBlanceRequired()
  { return InterestCheckingAccountsClass::minimumBalanceRequired; }
